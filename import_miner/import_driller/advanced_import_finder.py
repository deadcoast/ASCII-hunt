...
class AdvancedImportFinder(importlib.abc.MetaPathFinder):
    def __init__(self) -> None:
        ...
        self.symbol_usage: dict[str, list[dict[str, Any]]] = {}
...
class SymbolTracker:
    ...
    def install(self) -> None:
        ...
        def tracked_import(name: str, *args: Any, **kwargs: Any) -> ModuleType:
            """
            ...
            :param args: The arguments to pass to the original import function
            :param kwargs: The keyword arguments to pass to the original import function
    ...
    def _create_wrapper(
        self, func: Callable[..., Any], module_name: str, attr_name: str
    ) -> Callable[..., Any]:
        """
