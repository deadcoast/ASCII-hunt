...
class TestConfigManager(unittest.TestCase):
    ...
    def test_get_style_config(self) -> None:
    ...
    def test_get_validation_config(self) -> None:
    ...
    def test_get_error_handling_config(self) -> None:
    ...
    def test_get_performance_config(self) -> None:
    ...
    def test_get_reporting_config(self) -> None:
    ...
    def test_get_directories_config(self) -> None:
    ...
    def test_style_config_required_properties(self) -> None:
    ...
    def test_style_config_forbidden_properties(self) -> None:
        """Test style config forbidden properties."""
        style_config = self.config_manager.get_style_config("core_processing")
        self.assertIn("stroke-dasharray", style_config.forbidden)

    def test_multiple_style_configs(self) -> None:
