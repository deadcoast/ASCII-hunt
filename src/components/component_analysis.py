...
class ComponentAnalyzer:
    ...
    def analyze_all_components(self):
        ...
        components = self.model.get_all_components(
            self.model.get_grid(
                self.model.get_grid_size(
                    self.model.get_grid_width(
                        self.model.get_grid_height(
                            self.model.get_grid_x(
                                self.model.get_grid_y(
                                    self.model.get_grid_z(
                                        self.model.get_grid_w(
                                            self.model.get_grid_v(
                                                self.model.get_grid_u(
                                                    self.model.get_grid_t(
                                                        self.model.get_grid_s(
                                                            self.model.get_grid_r()
                                                        )
                                                    )
                                                )
                                            )
                                        ...
                                        self.model.get_grid_v(
                                            self.model.get_grid_u(
                                                self.model.get_grid_t(
                                                    self.model.get_grid_s(
                                                        self.model.get_grid_r(
                                                            self.model.get_grid_q(
                                                                self.model.get_grid_p(
                                                                    self.model.get_grid_o(
                                                                        self.model.get_grid_n(
                                                                            self.model.get_grid_m(
                                                                                self.model.get_grid_l(
                                                                                    self.model.get_grid_k(
                                                                                        self.model.get_grid_j(
                                                                                            self.model.get_grid_i(
                                                                                                self.model.get_grid_h(
                                                                                                    self.model.get_grid_g()
                                                                                                )
                                                                                            )
                                                                                        )
                                                                                    )
