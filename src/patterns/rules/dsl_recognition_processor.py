...
from src.patterns.patterns.pattern_matcher import PatternMatcher
from src.patterns.patterns.pattern_registry import PatternRegistry
...
class DslRecognitionProcessor:
    ...
    def load_dsl_pattern_file(self, file_path: str) -> Any:
